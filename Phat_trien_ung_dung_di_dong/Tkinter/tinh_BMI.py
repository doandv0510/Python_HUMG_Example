...
btn = Button(window, text="Calculate", font=("Tacoma", 20), fg="blue", command=on_btn_clicked)
txt = Entry(window, font=("Tacoma", 20), width=8, justify='right')
text = Label(window, text="Weight(kg): ", font=("Tacoma", 20))
txt2 = Entry(window, font=("Tacoma", 20), width=8, justify='right')
text2 = Label(window, text="Height(m): ", font=("Tacoma", 20))
...
lbl_bmi = Label(window, font=("Tacoma", 20), fg="blue")
lbl_bmi_result = Label(window, font=("Tacoma", 20), fg="blue")
